  ...
  return (
    <>
      <footer id="footer_one">
          ...
          <div className="row">
            <div className="col-lg-4 col-md-12 col-sm-12 col-12">
              <div className="footer_left_side">
                ...
                <p>
                  <strong>InveShop</strong> çok satıcılı bir B2C hızlı e-ticaret şirketidir. Şirket ağırlıklı
                  olarak erkek, kadın ve çocuk giyimine odaklanmaktadır. ama aynı zamanda başka giysiler,
                  aksesuarlar, ayakkabılar, çantalar ve diğer moda ürünleri de sunuyoruz.
                </p>
        ...
        >
          <i className="fa fa-chevron-up mt-1"></i>
