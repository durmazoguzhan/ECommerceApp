            ...
            <div className="col-lg-6">
              <div className="contact_form_one contact_info_wrapper">
                ...
                <form
                  onSubmit={(e) => {
                    e.preventDefault();
                    Swal.fire("Teşekkürler", "Mesajınızı Bize Ulaştı", "success");
                  }}
                >
                  <div className="row">
                    ...
                    <div className="col-lg-12 col-md-12 col-sm-12 col-12">
                      ...
                      <div className="submit_bitton_contact_one">
                        <button value="Submit" className="theme-btn-one btn-black-overlay btn_md">
                          Gönder
                        </button>
                      </div>
                    </div>
                ...
                <ul>
                  ...
                  <li className="address_location">
                    <div className="contact_widget">
                      ...
                      <Link to="/">info@inveshop.com</Link>
                    </div>
                    <div className="contact_widget">
                      <i className="fa fa-globe"></i>
                      <Link to="/">InveShop.com</Link>
                    </div>
                  </li>
                </ul>
                <Map />
